...
public class OfferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        offrirService = (Button) findViewById(R.id.offrirService);
        ...
        offrirService.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void list_transport(){
        list.add("Offrir un déplacement");
    }
    public void list_courtage(){
        list.add("Transporter un colis");
    }
